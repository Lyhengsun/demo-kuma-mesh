...
public @interface ValidPositiveLongParam {
    ...
    @OverridesAttribute(constraint = Positive.class, name = "message") String positiveMessage() default "{fieldName} need to be a positive long integer";

    // Override Attributes for Max
    @OverridesAttribute(constraint = Max.class, name = "value") long maxValue() default Long.MAX_VALUE;
